...
def _text_candidate_row(record: MousRecord) -> dict[str, str]:
    ...
    return {
        ...
        "min_spw_width_nchan": str(meta.get("min_spw_width_nchan") or ""),
        "max_spw_width_nchan": str(meta.get("max_spw_width_nchan") or ""),
...
def _parse_candidates_text_row(row: dict[str, str]) -> MousRecord:
    ...
    archive_meta = {
        ...
        "min_spw_width_nchan": int(row["min_spw_width_nchan"]) if (row.get("min_spw_width_nchan") or "").strip().isdigit() else None,
        "max_spw_width_nchan": int(row["max_spw_width_nchan"]) if (row.get("max_spw_width_nchan") or "").strip().isdigit() else None,
